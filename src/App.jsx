...
const MOCK_DATA = [
  {
    ...
    "content": "Full content about AI goes here..."
  },
  {
    ...
    "content": "Full content about Quantum Computing goes here..."
  },
  {
    ...
    "urlToImage": "https://images.unsplash.com/photo-1593941707882-a5bba14938cb?w=800&q=80",
    "publishedAt": "2023-10-26T14:15:00Z",
    "content": "Full content about Electric Vehicles goes here..."
  }
];

const API_KEY = '903c0d6d947f4216aef197dece90a095'; // Replace with your actual NewsAPI key
      ...
      try {
        ...
        if (!response.ok) {
          if (response.status === 401) {
            throw new Error("Invalid API Key. Please update the API_KEY variable in App.jsx. Displaying mock data for layout demonstration.");
          }
